...
TFTA = function(i, coop, intent, coop_error, arb, arb_error, error_rate, arb_error_rate_type_1, arb_error_rate_type_2, standing, xi=0)
{
  if(i==1){
  # Coop without error on first move
   ...
   do_coop = ifelse(coop[i-1]==1 || (callArb==1 && arbEr==1 && coop[i-1]==0),1,0)  
