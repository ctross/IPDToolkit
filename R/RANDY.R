...
RANDY = function (i, coop, intent, coop_error, arb, arb_error, error_rate, 
    arb_error_rate_type_1, arb_error_rate_type_2, standing, xi=0, randy_p = 0.6) 
{
    if (i == 1) {
        result = c(1, 1, 0, 0, 0, standing, standing)
    }
    else {
        do_coop = rbinom(1, size = 1, randy_p)
